...
public class EventSetDescriptor extends FeatureDescriptor {
    ...
    private ArrayList<org.java.beans.MethodDescriptor> listenerMethodDescriptors;
    ...
    public EventSetDescriptor(Class<?> sourceClass, String eventSetName,
        ...
        listenerMethodDescriptors = new ArrayList<org.java.beans.MethodDescriptor>();
        listenerMethodDescriptors.add(new org.java.beans.MethodDescriptor(method));
        ...
        if (addListenerMethod == null || removeListenerMethod == null) {
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.38")); //$NON-NLS-1$
        }
    ...
    public EventSetDescriptor(Class<?> sourceClass, String eventSetName,
            Class<?> listenerType, String[] listenerMethodNames,
            String addListenerMethodName, String removeListenerMethodName,
            String getListenerMethodName) throws org.java.beans.IntrospectionException {
        ...
        for (String element : listenerMethodNames) {
            ...
            listenerMethodDescriptors.add(new org.java.beans.MethodDescriptor(m));
        }
    ...
    private Method findListenerMethodByName(String listenerMethodName)
        ...
        if (null == result) {
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.31", //$NON-NLS-1$
    ...
    public EventSetDescriptor(String eventSetName, Class<?> listenerType,
            ...
            Method removeListenerMethod) throws org.java.beans.IntrospectionException {
        ...
        if (listenerMethods != null) {
            ...
            for (Method element : listenerMethods) {
                ...
                this.listenerMethodDescriptors
                        .add(new org.java.beans.MethodDescriptor(element));
                // }
            }
        }
    ...
    public EventSetDescriptor(String eventSetName, Class<?> listenerType,
            org.java.beans.MethodDescriptor[] listenerMethodDescriptors,
        ...
        if (listenerMethodDescriptors != null) {
            this.listenerMethodDescriptors = new ArrayList<org.java.beans.MethodDescriptor>();

            for (org.java.beans.MethodDescriptor element : listenerMethodDescriptors) {
    ...
    private static void checkEventType(String eventSetName,
            Method listenerMethod) throws org.java.beans.IntrospectionException {
        ...
        if (firstParamTypeName == null
            ...
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.51", //$NON-NLS-1$
    ...
    public Method[] getListenerMethods() {
        ...
        if (listenerMethodDescriptors != null) {
            ...
            int index = 0;
            for (org.java.beans.MethodDescriptor md : listenerMethodDescriptors) {
    ...
    public org.java.beans.MethodDescriptor[] getListenerMethodDescriptors() {
    ...
    private Method findAddRemoveListenerMethod(Class<?> sourceClass,
            String methodName) throws org.java.beans.IntrospectionException {
        try {
