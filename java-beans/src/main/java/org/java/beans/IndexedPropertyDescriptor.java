...
public class IndexedPropertyDescriptor extends PropertyDescriptor {
    ...
    public IndexedPropertyDescriptor(String propertyName, Class<?> beanClass,
            ...
            String indexedSetterName) throws org.java.beans.IntrospectionException {
    ...
    private void setIndexedByName(Class<?> beanClass, String indexedGetterName,
        ...
        if (!isCompatible()) {
            ...
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.57")); //$NON-NLS-1$
        }
    }
    ...
    private void setIndexedReadMethod(Class<?> beanClass, String indexedGetterName)
        ...
        try {
            ...
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.58")); //$NON-NLS-1$
        } catch (SecurityException exception) {
            // beans.59=Security violation accessing indexed read method
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.59")); //$NON-NLS-1$
        }
    ...
    private void internalSetIndexedReadMethod(Method indexGetter)
        ...
        if (indexGetter == null) {
            if (indexedSetter == null) {
                if (getPropertyType() != null) {
                    ...
                    throw new org.java.beans.IntrospectionException(Messages
        ...
        if ((indexGetter.getParameterTypes().length != 1)
            ...
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.5B")); //$NON-NLS-1$
        }
        ...
        if (indexedReadType == Void.TYPE) {
            ...
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.5A")); //$NON-NLS-1$
        }
    ...
    private void setIndexedWriteMethod(Class<?> beanClass, String indexedSetterName)
        ...
        try {
            ...
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.5C")); //$NON-NLS-1$
        } catch (NoSuchMethodException e) {
            // beans.5D=No such indexed write method
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.5D")); //$NON-NLS-1$
        }
    ...
    private void internalSetIndexedWriteMethod(Method indexSetter,
            boolean initialize) throws org.java.beans.IntrospectionException {
        ...
        if (indexedSetterArgs.length != 2) {
            ...
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.5F")); //$NON-NLS-1$
        }
        if (indexedSetterArgs[0] != Integer.TYPE) {
            // beans.60=Indexed write method must take an int as its first argument
            throw new org.java.beans.IntrospectionException(Messages.getString("beans.60")); //$NON-NLS-1$
        }
