...
public class Introspector extends Object {
	 ...
	 */
    public static org.java.beans.BeanInfo getBeanInfo(Class<?> beanClass)
            throws org.java.beans.IntrospectionException {
     ...
     * @throws org.java.beans.IntrospectionException
     */
    public static org.java.beans.BeanInfo getBeanInfo(Class<?> beanClass, Class<?> stopClass)
            throws org.java.beans.IntrospectionException {
        if(stopClass == null){
            //try to use cache
     ...
     * @throws org.java.beans.IntrospectionException
     */
    public static org.java.beans.BeanInfo getBeanInfo(Class<?> beanClass, int flags)
            throws org.java.beans.IntrospectionException {
    ...
    private static StandardBeanInfo getBeanInfoImpl(Class<?> beanClass, Class<?> stopClass,
            int flags) throws org.java.beans.IntrospectionException {
        org.java.beans.BeanInfo explicitInfo = null;
        if (flags == USE_ALL_BEANINFO) {
        ...
        if (beanInfo.additionalBeanInfo != null) {
            for (int i = beanInfo.additionalBeanInfo.length-1; i >=0; i--) {
                org.java.beans.BeanInfo info = beanInfo.additionalBeanInfo[i];
        ...
        if (beanSuperClass != stopClass) {
            ...
            int superflags = flags == IGNORE_IMMEDIATE_BEANINFO ? USE_ALL_BEANINFO
                    : flags;
            org.java.beans.BeanInfo superBeanInfo = getBeanInfoImpl(beanSuperClass, stopClass,
                    superflags);
    ...
    private static org.java.beans.BeanInfo getExplicitBeanInfo(Class<?> beanClass) {
        ...
        org.java.beans.BeanInfo theBeanInfo = null;
        ...
        if (org.java.beans.BeanInfo.class.isAssignableFrom(beanClass)) {
            try {
     ...
     */
    private static org.java.beans.BeanInfo loadBeanInfo(String beanInfoClassName,
                                                        Class<?> beanClass) throws Exception{
        try {
            ClassLoader cl = beanClass.getClassLoader();
            if(cl != null){
                return (org.java.beans.BeanInfo) Class.forName(beanInfoClassName, true,
