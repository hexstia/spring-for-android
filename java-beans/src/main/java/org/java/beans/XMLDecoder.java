...
public class XMLDecoder {
    ...
    private static class DefaultExceptionListener implements org.java.beans.ExceptionListener {
    ...
    private class SAXHandler extends DefaultHandler {
        ...
        private Object executeCommon(Elem elem) throws Exception {
            ...
            if (elem.fromField) {
                ...
                return (new org.java.beans.Expression(f, "get", new Object[] { null }))
                        .getValue();
            }
            if (elem.fromOwner) {
                return owner;
            ...
            // execute
            org.java.beans.Expression exp = new Expression(elem.target, method, args.toArray());
            return exp.getValue();
        }
        ...
        private Method findMethod(Class<?> clazz, String methodName,
            ...
            Statement.MethodComparator comparator = new Statement.MethodComparator(methodName,
                    clazzes);
    ...
    private org.java.beans.ExceptionListener listener;
     ...
     */
    public XMLDecoder(InputStream inputStream, Object owner,
            org.java.beans.ExceptionListener listener) {
        this(inputStream, owner, listener, null);
    }

    public XMLDecoder(InputStream inputStream, Object owner,
                      org.java.beans.ExceptionListener listener, ClassLoader cl) {
     ...
     */
    public org.java.beans.ExceptionListener getExceptionListener() {
        return listener;
    }
